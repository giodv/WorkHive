...
namespace WorkHive.Infrastructure.Migrations
{
    ...
    [Migration("20230520092637_AddedMainEntitiesBetter")]
    partial class AddedMainEntitiesBetter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WHEventWHUser", b =>
                {
                    ...
                    b.Property<Guid>("GuestIdsId")
                        .HasColumnType("uuid");

                    b.HasKey("GuestEventsId", "GuestIdsId");

                    b.HasIndex("GuestIdsId");
