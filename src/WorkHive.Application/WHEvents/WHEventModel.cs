...
{
    public WHEventModel(WHEvent entity) : this(entity.Id, entity.OrganizerId, entity.StartDate, entity.EndDate, entity.Location, (int)entity.EventType, entity.Description, entity.MaxGuest, entity.GuestIds.Select(x => x.Id).ToList())
    {
