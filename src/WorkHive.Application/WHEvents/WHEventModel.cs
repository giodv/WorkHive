...
{
    public WHEventModel(WHEvent entity) : this(entity.Id, entity.OwnerId, entity.StartDate.DateTime, entity.EndDate.DateTime, entity.Location, (int)entity.EventAttributes, entity.Description, entity.MaxGuest, entity.Guests.Select(x => x.Id).ToList())
    {
